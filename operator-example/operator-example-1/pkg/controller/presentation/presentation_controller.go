...
import (
	...
	presentationv1beta1 "github.com/jphan169/test-operator/pkg/apis/presentation/v1beta1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &presentationv1beta1.Presentation{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &presentationv1beta1.Presentation{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcilePresentation) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &presentationv1beta1.Presentation{}
...
// For teting only: 
	deploymentChanged, err:=r.ensureLatestDeployment(instance)
	if err != nil {
		return reconcile.Result{}, err
	}
	err = r.ensureLatestPod(instance, deploymentChange)
	if err != nil {
		return reconcile.Result{}, err
	}
	return reconcile.Result{}, err
...
func (r *ReconcilePresentation) ensureLatestDeployment(instance *presentationv1beta1.Presentation) (bool, error){
	deployment := newDeployment(instance)

}

func newDeploymentForCR(cr *presentationv1beta1.Presentation) *corev1.Deployment {
	
}

// newPodForCR returns a busybox pod with the same name/namespace as the cr
func newPodForCR(cr *presentationv1beta1.Presentation) *corev1.Pod {
